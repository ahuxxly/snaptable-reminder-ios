...
powershell -ExecutionPolicy Bypass -File scripts/apple-release-next-actions.ps1 -EntryPackDirectory "C:\path\outside\repo\SnapTableReminder-AppStoreConnect-EntryPack" -SubmissionPacketDirectory "C:\path\outside\repo\SnapTableReminder-AppStoreSubmissionPacket" -MaterialsDirectory "C:\path\outside\repo\SnapTableReminder-Apple-Materials"
