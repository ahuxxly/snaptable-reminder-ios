...
Before collecting private Apple files, prepare a private folder outside this repository:

```powershell
powershell -ExecutionPolicy Bypass -File scripts/prepare-apple-materials-folder.ps1
```

After adding the private Apple materials, validate the folder:
...
Keep the private DSA evidence in the folder generated by `scripts/prepare-apple-materials-folder.ps1`.
...
The generated private materials folder expects these files under `02-signing/`.
